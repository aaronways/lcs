  ...
  problems: [
    {
      ...
      expert: `
Optional but strongly recommended. This renders behind its own "How an expert sees it"
...
**Ruled out on sight:** methods a beginner would reasonably consider and why an expert
discards them in under a second.

**The fast path:** the two or three lines that actually get the answer.

**The tell / free check:** the structural feature that made it obvious, and the
