registerChapter({
  ...
  guide: [
    {
      title: "Orientation: the one thing this chapter does",
      body: `
...
- **Subsystems combine algebraically**, which is the entire basis of Chapter 5.
...
*(Nise writes Newton's law as $\\sum F=0$ with the $Ma$ term moved to the left, precisely so
...
Two standing results worth memorizing:
